		  		...
		  		<div class="col-md-12 panel-primary">
		  			...
		  			<div class="content-box-large box-with-header">
		  				<div class="row">
							  ...
							  <!-- <div class="form-group">
							    <label for="inputEmail3" class="col-sm-2 control-label">Proje Fiyat</label>
							    <div class="col-sm-9">
							      <input type="text" name="proje_fiyat" class="form-control" placeholder="İş linkini giriniz.">
							    </div>
							  </div> -->
