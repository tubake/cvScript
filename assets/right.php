          ...
          if ($row["is_devam"]==1) {
            ...
            <hr>
             <div class="w3-container">
              ...
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $row["is_tarih"]; ?><span class="w3-tag w3-teal w3-round">Current</span></h6>
         ...
         foreach ($okulcek as $row) {
          if ($row["okul_devam"]==1) {
            ...
            <div class="w3-container">
              ...
              <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $row["okul_tarih"]; ?></h6>
        ...
        <?php 
         ...
         foreach ($projecek as $row) {
          ...
          <div class="w3-container">
            ...
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $row["proje_link"]; ?></h6>
